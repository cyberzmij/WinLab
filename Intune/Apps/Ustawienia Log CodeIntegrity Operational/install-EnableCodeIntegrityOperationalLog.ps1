<#
---
name: install-EnableCodeIntegrityOperationalLog.ps1
description: "Intune configuration script to enable and configure the Microsoft-Windows-CodeIntegrity/Operational event log."
risk: safe
source: local
