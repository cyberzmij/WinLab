# Konfiguracja aplikacji Win32 w Intune - Mozilla Firefox (Script-based)

Instalacja Mozilla Firefox przy użyciu metody "PowerShell script" w Intune i menedżera pakietów Winget w profilu użytkownika.
...
*   **Install script:** `install-firefox.ps1`
*   **Uninstall script:** `uninstall-firefox.ps1`
