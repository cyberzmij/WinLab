# Konfiguracja aplikacji Win32 w Intune - Google Chrome (Script-based)

Instalacja Google Chrome przy użyciu metody "PowerShell script" w Intune i menedżera pakietów Winget w profilu użytkownika.
...
*   **Install script:** `install-google-chrome.ps1`
*   **Uninstall script:** `uninstall-google-chrome.ps1`
...
*   **Script file:** `check-google-chrome.ps1`
